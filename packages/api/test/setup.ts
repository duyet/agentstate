...
const DDL_STATEMENTS: string[] = [
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS \`agent_states_project_id_state_key_idx\` ON \`agent_states\` (\`project_id\`,\`state_key\`)`,
  `CREATE INDEX IF NOT EXISTS \`agent_states_project_id_agent_id_idx\` ON \`agent_states\` (\`project_id\`,\`agent_id\`)`,
  `CREATE INDEX IF NOT EXISTS \`agent_states_project_id_updated_at_idx\` ON \`agent_states\` (\`project_id\`,\`updated_at\`)`,
  `CREATE INDEX IF NOT EXISTS \`agent_states_project_id_latest_sequence_idx\` ON \`agent_states\` (\`project_id\`,\`latest_sequence\`)`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS \`state_snapshots_project_id_state_key_sequence_idx\` ON \`state_snapshots\` (\`project_id\`,\`state_key\`,\`sequence\`)`,
  `CREATE INDEX IF NOT EXISTS \`state_snapshots_project_id_sequence_idx\` ON \`state_snapshots\` (\`project_id\`,\`sequence\`)`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS \`state_tags_project_id_state_key_tag_idx\` ON \`state_tags\` (\`project_id\`,\`state_key\`,\`tag\`)`,
  `CREATE INDEX IF NOT EXISTS \`state_tags_project_id_tag_idx\` ON \`state_tags\` (\`project_id\`,\`tag\`)`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS \`idempotency_keys_project_id_key_idx\` ON \`idempotency_keys\` (\`project_id\`,\`key\`)`,
  `CREATE INDEX IF NOT EXISTS \`idempotency_keys_project_id_created_at_idx\` ON \`idempotency_keys\` (\`project_id\`,\`created_at\`)`,
