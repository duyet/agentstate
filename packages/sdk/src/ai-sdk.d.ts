...
export declare function createAISDKChatStore(client: AgentState, options?: ChatStoreOptions): AISDKChatStore;
export declare function createAISDKRSCStateStore(client: AgentState, options: RSCStoreOptions): AISDKRSCStateStore;
export {};
