...
__export(ai_sdk_exports, {
  createAISDKChatStore: () => createAISDKChatStore,
  createAISDKRSCStateStore: () => createAISDKRSCStateStore
});
...
function createAISDKChatStore(client, options = {}) {
...
function createAISDKRSCStateStore(client, options) {
  const agentId = options.agentId ?? "agentstate-sdk";
