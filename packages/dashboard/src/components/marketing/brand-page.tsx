...
import { BrandCard, BrandRow } from "./brand-components";
          ...
          <div className="mx-auto w-full max-w-6xl px-6 py-12 pb-24">
            ...
            <div className="mb-10">
              ...
              <p className="mt-2 max-w-[560px] text-muted-foreground">
                A monotone node mark: one filled core wired to satellite adapters — the literal
                shape of a single state hub serving many runtimes.
              </p>
            </div>
