...
export function VibeChatbotIllustration() {
  return (
...
export function MultiSessionIllustration() {
  return (
    <svg aria-hidden="true" viewBox="0 0 320 160" fill="none" className="w-full h-full">
...
export function AgentAnalyticsIllustration() {
  return (
    <svg aria-hidden="true" viewBox="0 0 320 160" fill="none" className="w-full h-full">
      {/* Dashboard frame */}
      <rect
...
export function UniversalFrameworkIllustration() {
  return (
    <svg aria-hidden="true" viewBox="0 0 320 160" fill="none" className="w-full h-full">
      {/* Central API hub */}
...
export const useCases: readonly UseCaseItem[] = [
  {
    tag: "Vibe coding",
