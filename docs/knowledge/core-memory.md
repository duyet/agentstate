...
- Dashboard preview and production Pages workflows should use Bun, not `pnpm`: this repo ships `bun.lock` only, and dashboard builds require `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY`.
